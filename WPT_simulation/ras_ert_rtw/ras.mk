###########################################################################
## Makefile generated for component 'ras'. 
## 
## Makefile     : ras.mk
## Generated on : Mon Apr 11 22:07:06 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ras.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ras.elf
...
DEFINES_STANDARD = -DMODEL=ras -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/ras_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/ras_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/ras_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/ras_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ras.c.o : $(START_DIR)/ras_ert_rtw/ras.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ras_data.c.o : $(START_DIR)/ras_ert_rtw/ras_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
