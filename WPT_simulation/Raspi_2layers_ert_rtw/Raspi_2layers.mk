###########################################################################
## Makefile generated for component 'Raspi_2layers'. 
## 
## Makefile     : Raspi_2layers.mk
## Generated on : Thu Apr 14 09:43:57 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Raspi_2layers.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Raspi_2layers.elf
...
DEFINES_STANDARD = -DMODEL=Raspi_2layers -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Raspi_2layers_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Raspi_2layers_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Raspi_2layers.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/Raspi_2layers.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Raspi_2layers_data.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/Raspi_2layers_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Raspi_2layers_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
